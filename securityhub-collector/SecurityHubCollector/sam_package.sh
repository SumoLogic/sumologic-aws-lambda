...
sam deploy --template-file packaged.yaml --stack-name testingsecurityhubcollectorlambda --capabilities CAPABILITY_IAM --region $AWS_REGION --parameter-overrides S3SourceBucketName=securityhubfindings
