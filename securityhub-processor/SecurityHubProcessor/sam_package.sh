...
sam deploy --template-file packaged.yaml --stack-name testingsecurityhubprocessorlambda --capabilities CAPABILITY_IAM --region $AWS_REGION --parameter-overrides S3SourceBucketName=securityhubfindings
