...
docker pull public.ecr.aws/lambda/python:3.14-x86_64

# Run the Amazon lambda Linux container in detached mode
docker run -d --name sumologic-app-utils public.ecr.aws/lambda/python:3.14-x86_64 lambda_function.lambda_handler
